...
(function(t) { "function" == typeof define && define.amd ? define(["jquery"], t) : t(jQuery) })(function(t) {
    ...
    t.effects = { effect: {} },
        ...
        function() {
            ...
            t.expr && t.expr.filters && t.expr.filters.animated && (t.expr.filters.animated = function(e) { return function(i) { return !!t(i).data(a) || e(i) } }(t.expr.filters.animated)), t.uiBackCompat !== !1 && t.extend(t.effects, {
                ...
                saveStyle: function(t) { t.data(o, t[0].style.cssText) },
                restoreStyle: function(t) { t[0].style.cssText = t.data(o) || "", t.removeData(o) },
                ...
                effect: function() {
                    ...
                    return t.fx.off || !n ? c ? this[c](s.duration, h) : this.each(function() { h && h.call(this) }) : r === !1 ? this.each(d).each(i) : this.queue(l, d).queue(l, i)
                },
    ...
    var l;
    t.uiBackCompat !== !1 && (l = t.effects.define("transfer", function(e, i) { t(this).transfer(e, i) }))
});